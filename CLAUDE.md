...
Within `AddInfrastructureServices`, conditional compilation symbols (`#if UseIntegrations`, `#if UseAnyPersistence`) gate optional infrastructure projects.
...
- `UseAnyPersistence` — gates `RaTemplate.Persistence` project
